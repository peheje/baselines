...
def get_options(args=None):
    ...
    optParser.add_option("-k", "--timesteps", dest="timesteps", type="int",
                         default=3600, help="Maximum timesteps for route-file")
...
def optimizeGreenTime(groupFlowsMap, phaseLaneIndexMap, currentLength, options):
    ...
    satFlows = float(options.timesteps) / options.satheadway
